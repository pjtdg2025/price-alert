...
# Telegram bot Application (the python-telegram-bot v20+ app)
telegram_app = Application.builder().token(TOKEN).build()

# A simple message handler: when user sends a message (e.g. ticker), bot replies with confirmation
...
async def telegram_webhook(request: Request):
    ...
    await telegram_app.update_queue.put(update)  # Put update into telegram_app queue
